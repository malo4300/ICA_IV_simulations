...
get_signals = function(seed){
    read.csv(get_path(paste0("data_generation/differen_sample_sizes/data/estimated_signals_CausalVarEM_n:", n, "_"), seed))
}
...
p_values_iv = read.csv(paste("data_generation/differen_sample_sizes/CausalVarEM_n:",n,".csv", sep = ""), row.names = 1)[-1]
p_values_indp_cond = read.csv(paste("data_generation/differen_sample_sizes/p_values_conditional_CausalVarEM_n:",n,".csv", sep = ""), row.names = NULL, header= FALSE)[-1]
p_values_indp_undcond = read.csv(paste("data_generation/differen_sample_sizes/p_values_unconditional_CausalVarEM_n:", n, ".csv", sep = "") ,header= FALSE)[-1]
...
save_treatment_estimation(list(seed = ind-1,
                               ...
                               level_of_confounding = level_of_confounding), paste("CausalVarEM_confounder_source_n:", n, sep =""))
...
save_treatment_estimation(list(seed = ind-1,
                              ...
                              ols_biased = ols_biased,
                               column_extraction = estimated_treatment_efect_column_extraction,
                               level_of_confounding = level_of_confounding), paste("CausalVarEM_7_sources_n:", n, sep =""))
...
save_treatment_estimation(list(seed = ind-1,
                               ...
                               ols_biased = ols_biased,
                               column_extraction = estimated_treatment_efect_column_extraction,
                               level_of_confounding = level_of_confounding), paste("CausalVarEM_7_sources_nonsense_n:", n, sep =""))
...
save_treatment_estimation(list(seed = ind-1,
                               ...
                               ols_biased = ols_biased,
                               column_extraction = estimated_treatment_efect_column_extraction,
                               level_of_confounding = level_of_confounding), paste("CausalVarEM_iv_only_n:", n, sep =""))
